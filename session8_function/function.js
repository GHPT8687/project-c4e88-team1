...
let index = arr.findIndex(function (value) {    // value hoặc cái gì cũng được  // nếu cần mỗi value
    return value === 6;     // viết condition của đề bài
});

console.log(index);

arr.findIndex(function (v, i, a) {    // nếu cần cả value, index và array

});

arr.findIndex(function (v, i) {    // nếu cần mỗi index
    return i > 5;
});

function giaTriBang6(v, i, a) {    // cần dùng cái nào thì viết cái đấy
    return v === 6;                // y hệt function trên
}
...
function giaTriLonHon20(v) {         // nên tạo function mới cho dễ đọc
    return v === 20;
}